...
4.	Parameter Tuning – Random Forest model parameters were adjusted to achieve a better fit to the data.  This method improved the model accuracy from 71% to 77% when averaged over 100 trials.  More data would need to be collected to ensure this increase is not simply the result of overfitting the model to the dataset.
